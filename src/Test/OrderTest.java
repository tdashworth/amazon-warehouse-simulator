...
public class OrderTest {
	...
	public void orderCreationTest() {
		...
		assertEquals("Order:  Storage Shelfs: 1, 2, 3, 4 Ticks to pack: 10.", o.toString());
	}
	...
	public void orderSetTicksToPackTest() {
		...
		assertEquals("Order:  Storage Shelfs: 1, 2, 3, 4 Ticks to pack: 10 Total ticks used: 5.", o.toString());
		...
		assertEquals("Order:  Storage Shelfs: 1, 2, 3, 4 Ticks to pack: 10 Total ticks used: 7.", o.toString());
	}
