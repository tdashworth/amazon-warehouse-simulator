...
public class OrderTest {
	...
	public void orderSetTicksToPackTest() {
		...
		assertEquals(
				"Order(" + o.hashCode() + "): Storage Shelfs: [1, 2, 3, 4], Ticks to pack: 10, Total ticks to pack: 5",
				o.toString());

		// Update the number of ticks to pack again and ensure everything is still
		// correct
		...
		assertEquals(
				"Order(" + o.hashCode() + "): Storage Shelfs: [1, 2, 3, 4], Ticks to pack: 10, Total ticks to pack: 7",
				o.toString());
	}
