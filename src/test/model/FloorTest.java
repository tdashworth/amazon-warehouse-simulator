...
public class FloorTest {
  ...
  public void loadMoverTest() {
    Floor floor = new Floor(5, 3);
    AbstractMover robot1 = mockRobotWithLocation(new Location(2, 1));
    AbstractMover robot2 = mockRobotWithLocation(new Location(5, 5));
    AbstractMover robot3 = mockRobotWithLocation(new Location(2, 1));
  ...
  public void moveEntityTest() throws LocationNotValidException {
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: Location: [1, 1] is invalid because it's empty and nothing to move.",
          e.toString());
    }
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: Location: [2, 3] is invalid because it's outside of the floor boundaries.",
          e.toString());
    }
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: Location: [2, 2] is invalid because it's already occupied.",
          e.toString());
    }
  }
