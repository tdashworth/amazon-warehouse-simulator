...
public class FloorTest {
  ...
  public void loadMoverTest() {
    Floor floor = new Floor(5, 3);
    Mover robot1 = new Robot("r1", new Location(2, 1), null, 0, 0);
    Mover robot2 = new Robot("r2", new Location(5, 5), null, 0, 0);
    Mover robot3 = new Robot("r3", new Location(2, 1), null, 0, 0);
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: 5, 5 [column, row] is invalid because it's outside of the floor boundaries.",
          e.toString());
    }
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: 2, 1 [column, row] is invalid because it's already occupied.",
          e.toString());
    }
  }
  ...
  public void moveEntityTest() throws LocationNotValidException {
    ...
    try {
      ...
      assertEquals(
          "LocationNotValidException: -1, 0 [column, row] is invalid because it's outside of the floor boundaries.",
          e.toString());
    }
    ...
    try {
      ...
      assertEquals("LocationNotValidException: 1, 1 [column, row] is invalid because it's empty and nothing to move.", e.toString());
    }
    ...
    try {
      ...
      assertEquals("LocationNotValidException: 2, 3 [column, row] is invalid because it's outside of the floor boundaries.", e.toString());
    }
    ...
    try {
      ...
      assertEquals("LocationNotValidException: 2, 2 [column, row] is invalid because it's already occupied.", e.toString());
    }
  }
}
