...
public class Floor {
	 ...
	 * @throws Exception
	 */
	public void loadMover(AbstractMover moverEntity) throws LocationNotValidException {
	...
	public void moveEntity(Location oldLocation, Location newLocation) throws Exception {
		...
		// Move entity.
		AbstractMover moverEntity = grid[oldLocation.getColumn()][oldLocation.getRow()];
