 ...
 */
public class PackingStation extends AEntity implements IActor<Warehouse> {
	...
	public PackingStationStatus getStatus() {
		...
		boolean allItemsRecieved = this.currentOrder.getStorageShelfUIDs().size() == this.storageShelvesVisited.size();
